...
const DEFAULT_TITLE = "Ever Gauzy PM";
const DEFAULT_DESCRIPTION = "Made with Ever Gauzy PM, an AI-powered work management platform with publishing capabilities.";
