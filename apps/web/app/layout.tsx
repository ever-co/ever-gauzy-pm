...
export const meta = () => [
  ...
  { property: "og:title", content: "Ever Gauzy PM" },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://pm.gauzy.co/" },
  { property: "og:image", content: "https://pm.gauzy.co/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Ever Gauzy PM" },
  { name: "twitter:site", content: "" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://pm.gauzy.co/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Ever Gauzy PM" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Ever Gauzy PM" />
