 ...
 *
 * ever-gauzy fork: brand logo for "Ever Gauzy PM". This reuses the Gauzy logo
 * (as shown on app.gauzy.co) so the hosted UI shows no Plane branding. The three
 * public brand components (PlaneLogo / PlaneWordmark / PlaneLockup) render this so
 * every logo site across web + space is rebranded from one source.
 */
...
export function EverGauzyPmLogo({ width = "120", height = "24", className }: ISvgIcons) {
  return (
    <svg
      width={width}
      height={height}
      ...
      className={className}
      role="img"
      aria-label="Ever Gauzy PM"
    >
      <defs>
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Fira+Sans:ital,wght@1,300');`}</style>
      </defs>
      <g transform="translate(-218.189 -3662.039)">
        <g transform="translate(218.189 3666.449)">
          <path
